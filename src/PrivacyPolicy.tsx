    ...
    return (
        <div className="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Hoemp, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                        Agreement) refers to Hoemp.</p>
                </li>
                <li>
                    <p><strong>Country</strong> refers to: Netherlands</p>
                </li>
                <li>
                    <p><strong>Device</strong> means any device that can access the Service such as a computer, a cell
                        phone or a digital tablet.</p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    <p><strong>To provide You</strong> with news, special offers, and general information about other
                        ...
                        purchased or inquired about unless You have opted not to receive such information.</p>
                </li>
                <li>
            ...
            <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over
                ...
                reasonable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
            ...
            <ul>
                <li>By email: hoemp123@gmail.com</li>
            </ul>
        </div>
    )
}
